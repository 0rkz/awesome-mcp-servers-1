...
- <img src="https://raw.githubusercontent.com/0rkz/byte-mcp-server/main/assets/icon.svg" height="14"/> [PayPerByte](https://github.com/0rkz/byte-mcp-server)<sup><sup>⭐</sup></sup> - Verified, provenance-first per-byte USDC data feeds for AI agents on Arbitrum — subscribe or pay-per-call via x402, with verify-before-act on-chain provenance.
